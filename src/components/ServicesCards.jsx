...
export default function ServicesCards({ id, heading, imageUrl, icon }) {
  return (
    <Link to={`/services/${id}`}>
      <section
      ...
      >
        ...
        {/* Content */}
        <div className="absolute bottom-0 left-0 right-0 z-10 p-5 flex items-center gap-4 group-hover:bg-black/60 transition">
          ...
          <h2 className="font-bold mx-auto text-shadow-lg/30 text-white text-xl group-hover:translate-x-2 transition-transform duration-300">
            {heading}
          </h2>
        </div>
      </section>
