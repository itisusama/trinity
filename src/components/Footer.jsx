...
<div className='text-gray-500/80 pt-8 bg-[#f1f6f2] px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        Trinity Asset Care is a tech-driven short-term rental management startup helping property owners maximize income through expert virtual assistants, automation, and seamless guest experiences.
                    </p>
      ...
      {!submitted ? (
        ...
        <p className="mt-4 text-green-600 font-medium">Thank you for subscribing! 🎉</p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <Link to="/">Trinity</Link>. All rights reserved.</p>
            </div>
        </div>
    );
};